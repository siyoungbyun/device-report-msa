        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="reportDashboards"
                        to="/reports/reportDashboards"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="deviceDashboards"
                        to="/devices/deviceDashboards"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '단말기신고', 
                description: 'DeviceReport을 관리하는 화면입니다.', 
                key: 'deviceReports', 
                route: '/reports/deviceReports',
                ImageUrl: '',
            },
            { 
                title: '단말기', 
            ...
            { 
                title: '신고조회', 
                description: 'ReportDashboard을 관리하는 화면입니다.', 
                key: 'reportDashboards', 
                route: '/reports/reportDashboards',
                ImageUrl: '',
            },
            { 
                title: '단말기조회', 
                description: 'DeviceDashboard을 관리하는 화면입니다.', 
                key: 'deviceDashboards', 
                route: '/devices/deviceDashboards',
                ImageUrl: '',
            },
