    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex" style="background-color: white;">
                    <h1 class="align-self-center ml-3">알림이력</h1>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                <v-dialog v-model="openDialog" width="500">
                    <NotificationNotificationHistory :offline="offline"  :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row class="ma-0 pa-0">
            <v-col class="pa-4" cols="12" sm="6" md="3" v-for="(value, index) in values" :key="index">
                <NotificationNotificationHistory :offline="offline"
...
<script>
    ...
    import NotificationNotificationHistory from './../NotificationNotificationHistory.vue';

    export default {
        name: 'NotificationNotificationHistoryManager',
        components: {
            NotificationNotificationHistory,
        },
        props: {
            offline: Boolean
        },
